namespace Shopee
{
    partial class InputOperasionalForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label4 = new Label();
            label2 = new Label();
            numericBiaya = new NumericUpDown();
            txtNama = new TextBox();
            btnSave = new Button();
            ((System.ComponentModel.ISupportInitialize)numericBiaya).BeginInit();
            SuspendLayout();
            // 
            // labelHeader
            // 
            ...
            labelHeader.Text = "Input Operasional";
            ...
            // numericBiaya
            // 
            numericBiaya.Font = new Font("Segoe UI", 10.5F, FontStyle.Regular, GraphicsUnit.Point);
            numericBiaya.Location = new Point(43, 172);
            ...
            Controls.Add(numericBiaya);
            Controls.Add(panel1);
            Controls.Add(labelHeader);
            Controls.Add(label2);
            Controls.Add(label4);
            Name = "InputOperasionalForm";
            Text = "Input Transaksi";
            ((System.ComponentModel.ISupportInitialize)numericBiaya).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private NumericUpDown numericBiaya;
